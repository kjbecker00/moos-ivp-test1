...
#   Author: Ray Turrisi   
#   LastEd: May 2023
#   Objective: Provide parameters to launch two different teams with different behaviors for simulation
#
#-------------------------------------------------------------- 
...
do
    ...
    IX_VLAUNCH_ARGS+=" --team=$TEAM"

    vecho "Launching: $VNAME"
    vecho "IX_VLAUNCH_ARGS: [$IX_VLAUNCH_ARGS]"
    
    ./launch_vehicle_alt.sh $IX_VLAUNCH_ARGS 
done
